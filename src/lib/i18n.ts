...
const sk = {
  ...
  cta: {
    headline: "Chystáte akciu? Ozvite sa.",
    lead: "Napíšte nám, čo máte v pláne. Nemusíte mať hotový termín ani vedieť, čo presne potrebujete. Poradíme a povieme, čo dáva zmysel.",
    button: "Chcem viac informácií",
    note: "Nezáväzne. Ozveme sa do dvoch pracovných dní.",
  },
  form: {
    ...
    message: "Správa",
    messagePlaceholder: "Miesto a termín konania, predpokladaný počet ľudí, čo potrebujete zabezpečiť.",
...
const en: Dict = {
  nav: {
    ...
    reviews: "Reviews",
    contact: "Contact",
    reserve: "I want more information",
    menu: "Menu",
    close: "Close",
  ...
  hero: {
    ...
    primary: "I want more information",
  ...
  cta: {
    headline: "Planning an event? Get in touch.",
    lead: "Tell us what you have in mind. You do not need a fixed date or a finished list of requirements. We will advise on what makes sense.",
  ...
  form: {
    ...
    message: "Message",
    messagePlaceholder: "Venue and date, expected number of people, what you need us to cover.",
